        ...
        <section className="grid gap-8 md:grid-cols-3 md:items-center md:gap-6">
          <div className="md:col-span-2">
            <h2 className="text-3xl font-bold leading-tight">
              Welcome — thoughts and tutorials
            </h2>
            <p className="mt-3 text-zinc-600 dark:text-zinc-400 max-w-xl">
              I write about building web interfaces, authoring content with MDX,
              and practical frontend patterns. Browse the posts for topics.
            </p>
          ...
          <div className="hidden md:block self-start ">
            <div className="rounded-lg bg-white/60 dark:bg-white/5 p-4 shadow-sm">
              <h3 className="text-sm font-semibold">About me</h3>
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                Senior frontend engineer sharing experiments and notes. Please
              ...
              <div className="mt-3 flex items-center gap-3">
                <Avatar>
                  ...
                  <AvatarFallback className="border bg-white/60 dark:bg-white/5 shadow-sm">
                    AP
                  </AvatarFallback>
                </Avatar>
                <div>
